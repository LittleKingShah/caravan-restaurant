...
export default function MenuPage() {
  ...
  return (
    ...
    >
      ...
      {/* Hero banner */}
      <section className="relative h-[20vh] sm:h-[45vh] min-h-[140px] sm:min-h-[340px] flex items-end sm:items-center justify-center pb-6 sm:pb-0 overflow-hidden -mt-20 lg:-mt-24 pt-20 lg:pt-24">
        <div
