    ...
    >
      ...
      <section className="py-8 sm:py-24 bg-caravan-dark relative">
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          {/* Category tabs */}
          <div className="sticky top-[calc(5rem+env(safe-area-inset-top))] lg:top-[calc(6rem+env(safe-area-inset-top))] z-30 bg-caravan-dark/95 pb-4 sm:pb-8 pt-3 sm:pt-4 -mt-4">
            <div
